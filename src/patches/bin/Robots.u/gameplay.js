...
const replacements = [    
    ...
    //Patch Version 1.6.4
    {
        ...
        from: [0x50, 0x41, 0x58, 0x20, 0x50, 0x72, 0x69, 0x6D, 0x65, 0x20, 0x32, 0x30, 0x31, 0x32, 0x20, 0x7C, 0x7C, 0x20, 0x50, 0x72, 0x65, 0x2D, 0x41, 0x6C, 0x70, 0x68, 0x61],
          to: [0x50, 0x41, 0x58, 0x2B, 0x20, 0x43, 0x6F, 0x6D, 0X6D, 0x75, 0x6E, 0x69, 0x74, 0x79, 0x20, 0x50, 0x61, 0x74, 0x63, 0x68, 0x20, 0x31, 0x2E, 0x36, 0x2E, 0x34, 0x20]
    },
    ...
    { offset: 0x0054E539, from: [0x9A, 0x99, 0x19, 0x3E], to: [0xCD, 0xCC, 0x4C, 0x3E], }, //Decrease MG turret refire time from 0.15s to 0.20s
    { offset: 0x0054E58D, from: [0x2C, 0x01], to: [0xB4, 0x00] }, //Decrease Turret initial Health to 198
    { offset: 0x0054E5A9, from: [0x2C, 0x01], to: [0xB4, 0x00] }, //Decrease Turret max Health to 198    
